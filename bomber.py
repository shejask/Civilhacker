...
W='\033[0m'
# The Credit For This Code Goes To CIVIL HACKER And All Other Contributors Listed At https://github.com/CIVIL HACKER/TBomb
        ...
        try:
            ...
            if cc == "91":
                ...
                if success > 0:
                    ...
                    print(
                        '\t\tPlease Send A Mail T civilhacker9929@gmail.com To Let Us Know...')
                    input('Press Enter To Exit...')
                    exit()
...
def update():
    ...
    for fl in stuff_to_update:
        dat = urllib.request.urlopen(
            "https://raw.githubusercontent.com/CIVIL HACKER/TBomb/master/" + fl).read()
        file = open(fl, 'wb')
        file.write(dat)
        file.close()
    print('\n\t\tUpdated Successfull !!!!')
...
ver = urllib.request.urlopen(
    "https://raw.githubusercontent.com/CIVIL HACKER/TBomb/master/.version").read().decode('utf-8')
verl = ''
try:
...
try:
    noti = urllib.request.urlopen(
        "https://raw.githubusercontent.com/CIVIL HACKER/TBomb/master/.notify").read().decode('utf-8')
